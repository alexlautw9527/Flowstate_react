        ...
        <div className="">
          <div className="flex items-center mr-4 mb-2">
            ...
            <div className="bg-white border-2 rounded-md border-gameboy w-8 h-8 flex flex-shrink-0 justify-center items-center mr-2 focus-within:border-gameboy ">
              {completedAt && (
                <i className="fa-solid fa-check text-gameboy"></i>
              )}
            </div>
            ...
            <img
              ...
              className="w-10 ml-auto opacity-0 hover:opacity-100 cursor-pointer"
            />
          </div>
        </div>
      </li>
  ...
  return (
    <>
      <div className="bg-[#A10036] font-pixel mb-5 text-secondary flex">
        <div
          className="relative basis-1/3 h-14 text-center cursor-pointer flex items-center justify-center hover:border-b-4"
          data-category="all"
          onClick={(e) => {
            onClickPagination(e);
          }}
...
function TodoListContent({
  ...
  return (
    <>
      <TodoListPagination onClickPagination={onClickPagination} />
      <ul className="px-3">{mapTodoListItem(paginationState)}</ul>
    </>
  );
}
